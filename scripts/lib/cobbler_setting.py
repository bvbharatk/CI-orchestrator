...
__CHEETAH_genTime__ = 1466515738.1279669
__CHEETAH_genTimestamp__ = 'Tue Jun 21 09:28:58 2016'
__CHEETAH_src__ = 'settings'
__CHEETAH_srcLastModified__ = 'Tue Jun 21 09:28:24 2016'
...
default_name_servers: [''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"driver_vm_ip",True) # u'$driver_vm_ip' on line 79, col 24
        if _v is not None: write(_filter(_v, rawExpr=u'$driver_vm_ip')) # from line 79, col 24.
        write(u''',8.8.8.8]
...
default_password_crypted: "$1$Lh3vpMWO$Zn3QbHWnCAYlpAxGottix0"
...
''')
        write(u'''# Current valid values are: cheetah, jinja2
...
puppet_server: ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"driver_vm_hostname",True) # u'${driver_vm_hostname}' on line 225, col 16
        if _v is not None: write(_filter(_v, rawExpr=u'${driver_vm_hostname}')) # from line 225, col 16.
        write(u""" reportdir = /var/lib/puppet/reports
...
puppet_version: """)
        _v = VFSL([locals()]+SL+[globals(), builtin],"puppet_version",True) # u'${puppet_version}' on line 229, col 17
        if _v is not None: write(_filter(_v, rawExpr=u'${puppet_version}')) # from line 229, col 17.
        write(u'''
...
#bind_master: 10.223.255.196
bind_master: ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"driver_vm_ip",True) # u'${driver_vm_ip}' on line 250, col 14
        if _v is not None: write(_filter(_v, rawExpr=u'${driver_vm_ip}')) # from line 250, col 14.
        write(u"""
...
manage_forward_zones: [""")
        _v = VFSL([locals()]+SL+[globals(), builtin],"forward_zone",True) # u'${forward_zone}' on line 262, col 24
        if _v is not None: write(_filter(_v, rawExpr=u'${forward_zone}')) # from line 262, col 24.
        write(u''']
#manage_reverse_zones: [10.147]
manage_reverse_zones: [''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"reverse_zone",True) # u'${reverse_zone}' on line 264, col 24
        if _v is not None: write(_filter(_v, rawExpr=u'${reverse_zone}')) # from line 264, col 24.
        write(u''']
...
next_server: ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"driver_vm_ip",True) # u'${driver_vm_ip}' on line 269, col 14
        if _v is not None: write(_filter(_v, rawExpr=u'${driver_vm_ip}')) # from line 269, col 14.
        write(u''' 
...
#server: 10.223.255.196
server: ''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"driver_vm_ip",True) # u'${driver_vm_ip}' on line 385, col 9
        if _v is not None: write(_filter(_v, rawExpr=u'${driver_vm_ip}')) # from line 385, col 9.
        write(u''' 
